# Example from the SimPy documentaion file:  
...
def moviegoer(env, movie, num_tickets, theater):
   ...
   # a certain *movie* in a *theater*. If the movie becomes sold out, she leaves the theater. 
   # If she gets to the counter, she tries to buy a number of tickets. 
   # If not enough tickets are left, she argues with the teller and leaves.
   # If at most one ticket is left after the moviegoer bought her tickets, 
   # the *sold out* event for this movie is triggered causing all remaining moviegoers to leave.    
